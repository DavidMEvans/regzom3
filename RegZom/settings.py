"""
Django settings for RegZom project.
...
STRIPE_PUBLISHABLE = os.getenv('STRIPE_PUBLISHABLE', 'pk_live_J8g7zMWZliFbRrze8s608EU3')
STRIPE_SECRET = os.getenv('STRIPE_SECRET', 'sk_live_Ff3eQ0AGZci4zgHMwe08bUQc')